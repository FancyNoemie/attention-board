...
int duration[5] = { 
  60, 20, 1380, 1380, 1380 //<-- Ici {60, 20, 1380, 1380, 1380} donne {1h , 20min , 23h , 23h , 23h}
  }; 
...
const int led[5] = {6,5,4,3,2};
int button[5] = {18,17,16,15,14};
int butTone[5] = {262,294,330,349,392};
